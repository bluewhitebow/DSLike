...
namespace Retake
{
    public static class StaticFunctions
    {
        public static void DeepCopyWeapon(Weapon from,Weapon to)
        {
            ...
            to.modelPrefeb = from.modelPrefeb;
        ...
        public static void DeepCopyAction(Weapon w, ActionInput inp, ActionInput assign, List<Action> actionLsit,bool isLeftHand = false)
        {

            Action a = GetAction(assign,actionLsit);
        ...
        public static void DeepCopyConsumables(Consumable to,Consumable from)
        {
